...
public class com_gwtplatform_mvp_client_DesktopGinjectorImpl implements com.gwtplatform.mvp.client.DesktopGinjector {
  ...
  public javax.inject.Provider<com.projectname.project.client.application.ApplicationPresenter> getcomprojectnameprojectclientapplicationApplicationPresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_com_projectname_project_client_application().get_Key$type$com$google$inject$Provider$com$projectname$project$client$application$ApplicationPresenter$$_annotation$$none$$();
  }
  
  public javax.inject.Provider<com.projectname.project.client.application.home.HomePresenter> getcomprojectnameprojectclientapplicationhomeHomePresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_com_projectname_project_client_application_home().get_Key$type$com$google$inject$Provider$com$projectname$project$client$application$home$HomePresenter$$_annotation$$none$$();
  }
