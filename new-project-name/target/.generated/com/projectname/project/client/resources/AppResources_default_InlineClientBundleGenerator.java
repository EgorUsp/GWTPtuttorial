...
public class AppResources_default_InlineClientBundleGenerator implements com.projectname.project.client.resources.AppResources {
  ...
  private void normalizeInitializer() {
    normalize = new com.projectname.project.client.resources.AppResources.Normalize() {
  ...
  private static class normalizeInitializer {
    ...
    static com.projectname.project.client.resources.AppResources.Normalize get() {
      return normalize;
    }
  }
  public com.projectname.project.client.resources.AppResources.Normalize normalize() {
    return normalizeInitializer.get();
  }
  private void styleInitializer() {
    style = new com.projectname.project.client.resources.AppResources.Style() {
      private boolean injected;
      public boolean ensureInjected() {
        if (!injected) {
          injected = true;
  ...
  private static class styleInitializer {
    ...
    static com.projectname.project.client.resources.AppResources.Style get() {
      return style;
    }
  }
  public com.projectname.project.client.resources.AppResources.Style style() {
    return styleInitializer.get();
  }
  private static java.util.HashMap<java.lang.String, com.google.gwt.resources.client.ResourcePrototype> resourceMap;
  private static com.projectname.project.client.resources.AppResources.Normalize normalize;
  private static com.projectname.project.client.resources.AppResources.Style style;
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'normalize': return this.@com.projectname.project.client.resources.AppResources::normalize()();
      case 'style': return this.@com.projectname.project.client.resources.AppResources::style()();
    }
    return null;
  }-*/;
}
